...
class SearchCrepusculoDelegate extends SearchDelegate {
  @override
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    listCrepusculo = query.isEmpty
        ? crepusculoServices.propiedadesLibro
        : crepusculoServices.propiedadesLibro
            .where((crepusculo) => crepusculo.volumeInfo!.title
                .toLowerCase()
                .trim()
                .toUpperCase()
    ...
    if (listCrepusculo.isEmpty) {
      ...
      return ListView.builder(
        ...
        itemCount: listCrepusculo.length,
        itemBuilder: (context, index) {
          final listitem = listCrepusculo[index];
          return Column(
            children: <Widget>[
              Padding(
  ...
  Widget buildResults(BuildContext context) {
    final librosServices = Provider.of<CrepusculoServices>(context);
    List<Book> listCrepusculo = [];
    /*Creo una variable y si la consulta es vacia que me muestre todos los libros y si no que me muestre
    todos los titulos de los libros que empiecen con mi consulta*/
                ...
                child: Card(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: ListTile(
                        onTap: () {
                          Book idCrepusculo = listCrepusculo[index];
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => DatosCrepusculo(
                                      index, listCrepusculo, idCrepusculo)));
                        },
                        trailing: const Icon(Icons.arrow_forward_ios_outlined),
                        title: Text(
                          //Operacion ternaria para saber cargar los titulos de libros
