...
class DatosPaulo extends StatelessWidget {
  final int estado;
  ...
  Widget build(BuildContext context) {
    ...
    final datosServices = Provider.of<PauloServices>(context);
                      ...
                      child: Column(children: [
                        ...
                        ListTile(
                            title: (idPaulo!
                                ...
                                : (Image.network(
                                    idPaulo!.volumeInfo!.imageLinks!.thumbnail!,
                                    height: 300,
                                    width: 250,
                                    fit: BoxFit.fill,
                                  ))),
                        ...
                        ListTile(
                          subtitle: (idPaulo!.volumeInfo!.description) == null
                              ? const Text(
                              ...
                              : Text(
                                  idPaulo!.volumeInfo!.description!,
                                  style: const TextStyle(
                                    ...
                                    child: Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          ...
                                          child: (idPaulo!.saleInfo!.buyLink) ==
                                                  null
                                              ? IconButton(
                                                  icon: const Icon(
