...
class DatosLibros extends StatelessWidget {
  final int estado;
  ...
  Widget build(BuildContext context) {
                ...
                ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: Column(children: [
                        ...
                        Text(id!.volumeInfo!.imageLinks!.thumbnail!) == null
                            ? Image.asset(
                        ...
                        Text(id!.volumeInfo!.description!) == null
                            ? const Text(
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                //OnTap del link de compra de SearchDelegate
                                child: InkWell(
                                    onTap: () async {
                                      try {
                                    ...
                                    child: Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          ...
                                          child: (id!.saleInfo!.buyLink) == null
                                              ? IconButton(
                                                  icon: const Icon(
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: InkWell(
                                    //OnTap del pdf del SearchDelegate
                                    onTap: () async {
                                      try {
                                        //Hace la peticion al url de mi modelado de clases
                                        await launchUrlString(
                                            id!.accessInfo!.webReaderLink!);
                                      } catch (error) {
                                        debugPrint(
                                            'Error inesperado, reinicie la aplicacion');
                                      }
    ...
    final datosServices = Provider.of<BookServices>(context);
