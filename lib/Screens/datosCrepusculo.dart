...
class DatosCrepusculo extends StatelessWidget {
  final int estado;
                ...
                ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: Column(children: [
                        ...
                        ListTile(
                          subtitle:
                              (idCrepusculo!.volumeInfo!.description) == null
                                  ? const Text(
                                  ...
                                  : Text(
                                      idCrepusculo!.volumeInfo!.description!,
                                      style: const TextStyle(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                    ...
                                    onTap: () async {
                                      try {
                                        //Hace la peticion al url de mi modelado de clases
                                        await launchUrlString(idCrepusculo!
